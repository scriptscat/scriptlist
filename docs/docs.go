...
// 2025-08-01 10:56:54.866865 +0800 CST m=+0.206288751
package docs
...
var doc = `{
    ...
    "paths": {
        ...
        "/scripts/statistics-token": {
            "post": {
                "description": "获取统计token",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/script.GetStatisticsTokenRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "properties": {
                                ...
                                "data": {
                                    "$ref": "#/definitions/script.GetStatisticsTokenResponse"
                                },
                                "msg": {
                                    "type": "string"
                                }
    ...
    "definitions": {
        ...
        "script.GetStatisticsTokenRequest": {
            "type": "object"
        },
        "script.GetStatisticsTokenResponse": {
            "type": "object",
            "properties": {
                "token": {
                    "type": "string"
