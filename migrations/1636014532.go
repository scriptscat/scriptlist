...
import (
	...
	entity2 "github.com/scriptscat/scriptlist/internal/domain/statistics/entity"
	"gorm.io/gorm"
)

func T1617420365() *gormigrate.Migration {
...
func T1622952090() *gormigrate.Migration {
	return &gormigrate.Migration{
		ID: "1622952090",
		Migrate: func(tx *gorm.DB) error {
...
func T1627371597() *gormigrate.Migration {
	return &gormigrate.Migration{
		ID: "1627371597",
		Migrate: func(tx *gorm.DB) error {
...
func T1627723150() *gormigrate.Migration {
	return &gormigrate.Migration{
		ID: "1627723150",
		Migrate: func(tx *gorm.DB) error {
...
func T1627908382() *gormigrate.Migration {
	return &gormigrate.Migration{
		ID: "1627908382",
		Migrate: func(tx *gorm.DB) error {
