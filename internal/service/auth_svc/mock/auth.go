...
func (mr *MockAuthSvcMockRecorder) Get(ctx interface{}) *gomock.Call {
...
func (mr *MockAuthSvcMockRecorder) GetLoginToken(ctx, uid, loginId, token interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthSvcMockRecorder) GetLogoutStruct(ctx, uid, loginId, token interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthSvcMockRecorder) Login(ctx, uid interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthSvcMockRecorder) OAuthCallback(ctx, req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthSvcMockRecorder) Refresh(ctx, uid, loginId, token interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthSvcMockRecorder) RequireLogin(force interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthSvcMockRecorder) SetCtx(ctx, uid interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
