...
type UpdateCodeRequest struct {
	...
	Public     script.Public        `form:"public" binding:"required,number" label:"公开类型"` // 公开类型：1 公开 2 半公开
	Unwell     script.UnwellContent `form:"unwell" binding:"required,number" label:"不适内容"`
}
